...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md bg-bg-secondary p-8 border border-border-theme relative overflow-hidden"
      style={{
    ...
    >
      <div className="absolute -top-24 -right-24 w-48 h-48 bg-accent rounded-full opacity-20 blur-3xl pointer-events-none"></div>
      <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-accent rounded-full opacity-20 blur-3xl pointer-events-none"></div>
      ...
      <div className="relative z-10">
        ...
        <p className="text-center text-text-muted mb-8 text-sm">Sign in to continue to IR one</p>
        ...
        <div className="mt-6 flex items-center">
          ...
          <span className="px-3 text-xs text-text-muted uppercase">Or continue with</span>
          <div className="flex-1 border-t border-border-theme"></div>
        </div>
        ...
        <div className="mt-6">
          <button
            ...
            className="w-full bg-bg-tertiary border border-border-theme text-text-primary font-medium rounded-md py-2.5 flex items-center justify-center gap-2 hover:bg-bg-secondary transition-colors"
          >
